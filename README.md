...
A merkle tree (also known as a hash tree) is a tree in which every leaf node is labelled with a hash of a data block, and every other node is labbelled with a hash of the labbels of its children. 
